...
namespace Naos.Slack.Domain
{
    ...
    [Serializable]
    public partial class SendSlackMessageRequestedEvent<TId> : IModel<SendSlackMessageRequestedEvent<TId>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SendSlackMessageRequestedEvent{TId}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SendSlackMessageRequestedEvent<TId> left, SendSlackMessageRequestedEvent<TId> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SendSlackMessageRequestedEvent{TId}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SendSlackMessageRequestedEvent<TId> left, SendSlackMessageRequestedEvent<TId> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SendSlackMessageRequestedEvent<TId> other)
        {
            ...
            var result = this.TimestampUtc.IsEqualTo(other.TimestampUtc)
                      ...
                      && this.SendSlackMessageRequest.IsEqualTo(other.SendSlackMessageRequest);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SendSlackMessageRequestedEvent<TId>);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash(this.TimestampUtc)
            .Hash(this.Id)
            .Hash(this.SendSlackMessageRequest)
            .Value;

        /// <inheritdoc />
        public new SendSlackMessageRequestedEvent<TId> DeepClone() => (SendSlackMessageRequestedEvent<TId>)this.DeepCloneInternal();
        ...
        {
            var result = new SendSlackMessageRequestedEvent<TId>(
                                 this.Id == null ? default : this.Id.DeepClone(),
                                 timestampUtc,
                                 this.SendSlackMessageRequest?.DeepClone());
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="SendSlackMessageRequest" />.
        /// </summary>
        /// <param name="sendSlackMessageRequest">The new <see cref="SendSlackMessageRequest" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="SendSlackMessageRequestedEvent{TId}" /> using the specified <paramref name="sendSlackMessageRequest" /> for <see cref="SendSlackMessageRequest" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SendSlackMessageRequestedEvent<TId> DeepCloneWithSendSlackMessageRequest(SendSlackMessageRequestBase sendSlackMessageRequest)
        {
            var result = new SendSlackMessageRequestedEvent<TId>(
                                 this.Id == null ? default : this.Id.DeepClone(),
                                 this.TimestampUtc.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Slack.Domain.{this.GetType().ToStringReadable()}: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Id = {this.Id?.ToString() ?? "<null>"}, SendSlackMessageRequest = {this.SendSlackMessageRequest?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.SendSlackMessageRequest, options, propertyPathTracker, nameof(this.SendSlackMessageRequest));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
