...
namespace Naos.Slack.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<UploadFileToSlackOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<UploadFileToSlackOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<UploadFileToSlackOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UploadFileToSlackOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<UploadFileToSlackOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Slack.Domain.UploadFileToSlackOp: UploadFileToSlackRequest = {systemUnderTest.UploadFileToSlackRequest?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<UploadFileToSlackOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<UploadFileToSlackOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<UploadFileToSlackOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<UploadFileToSlackOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<UploadFileToSlackOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<UploadFileToSlackOp>
                {
                    ...
                    {
                        var referenceObject = A.Dummy<UploadFileToSlackOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<UploadFileToSlackOp>
                        {
                            SystemUnderTest = new UploadFileToSlackOp(
        ...
        private static readonly DeepCloneWithTestScenarios<UploadFileToSlackOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<UploadFileToSlackOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UploadFileToSlackOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<UploadFileToSlackOp>().ThatIs(_ => !systemUnderTest.UploadFileToSlackRequest.IsEqualTo(_.UploadFileToSlackRequest));

                        var result = new SystemUnderTestDeepCloneWithValue<UploadFileToSlackOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly UploadFileToSlackOp ReferenceObjectForEquatableTestScenarios = A.Dummy<UploadFileToSlackOp>();

        private static readonly EquatableTestScenarios<UploadFileToSlackOp> EquatableTestScenarios = new EquatableTestScenarios<UploadFileToSlackOp>()
            .AddScenario(() =>
                new EquatableTestScenario<UploadFileToSlackOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new UploadFileToSlackOp[]
                    {
                        new UploadFileToSlackOp(
                                ReferenceObjectForEquatableTestScenarios.UploadFileToSlackRequest),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new UploadFileToSlackOp[]
                    {
                        new UploadFileToSlackOp(
                                A.Dummy<UploadFileToSlackOp>().Whose(_ => !_.UploadFileToSlackRequest.IsEqualTo(ReferenceObjectForEquatableTestScenarios.UploadFileToSlackRequest)).UploadFileToSlackRequest),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<SendSlackMessageOp>(),
                    },
                });

        private static readonly ValidModelTestScenarios<UploadFileToSlackOp> ValidModelTestScenarios = new ValidModelTestScenarios<UploadFileToSlackOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<UploadFileToSlackOp>
                {
                    Name = "a dummy UploadFileToSlackOp should be valid",
                    SystemUnderTest = A.Dummy<UploadFileToSlackOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void UploadFileToSlackOp___Should_implement_IModel_of_UploadFileToSlackOp___When_reflecting()
            {
                // Arrange
                var type = typeof(UploadFileToSlackOp);

                var expectedModelMethods = typeof(IModel<UploadFileToSlackOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<UploadFileToSlackOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UploadFileToSlackOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(UploadFileToSlackOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (UploadFileToSlackOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "UploadFileToSlackRequest" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (UploadFileToSlackOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(UploadFileToSlackOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<UploadFileToSlackOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                UploadFileToSlackOp systemUnderTest1 = null;
                UploadFileToSlackOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    UploadFileToSlackOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_UploadFileToSlackResponse___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<UploadFileToSlackResponse> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<UploadFileToSlackResponse>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_UploadFileToSlackResponse___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<UploadFileToSlackResponse>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_UploadFileToSlackResponse___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<UploadFileToSlackResponse>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_UploadFileToSlackResponse___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<UploadFileToSlackResponse>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_UploadFileToSlackResponse___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<UploadFileToSlackResponse>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UploadFileToSlackOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UploadFileToSlackOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UploadFileToSlackOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UploadFileToSlackOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UploadFileToSlackOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
