...
namespace Naos.Slack.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<MessageAuthorIcon> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<MessageAuthorIcon>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<MessageAuthorIcon>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MessageAuthorIcon>();

                        var result = new SystemUnderTestExpectedStringRepresentation<MessageAuthorIcon>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Slack.Domain.MessageAuthorIcon: ResourceId = {systemUnderTest.ResourceId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ResourceIdKind = {systemUnderTest.ResourceIdKind.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<MessageAuthorIcon> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<MessageAuthorIcon>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MessageAuthorIcon>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'resourceId' is null scenario",
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new MessageAuthorIcon(
                                             null,
                                             referenceObject.ResourceIdKind);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "resourceId", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MessageAuthorIcon>
                {
                    Name = "constructor should throw ArgumentException when parameter 'resourceId' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<MessageAuthorIcon>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "resourceId", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MessageAuthorIcon>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<MessageAuthorIcon> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<MessageAuthorIcon>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MessageAuthorIcon>
                {
                    Name = "ResourceId should return same 'resourceId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<MessageAuthorIcon>();

                        var result = new SystemUnderTestExpectedPropertyValue<MessageAuthorIcon>
                        {
                            SystemUnderTest = new MessageAuthorIcon(
                                                      referenceObject.ResourceId,
                                                      referenceObject.ResourceIdKind),
                            ExpectedPropertyValue = referenceObject.ResourceId,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MessageAuthorIcon>
                {
                    Name = "ResourceIdKind should return same 'resourceIdKind' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<MessageAuthorIcon>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<MessageAuthorIcon>
                        {
                            SystemUnderTest = new MessageAuthorIcon(
                                                      referenceObject.ResourceId,
                                                      referenceObject.ResourceIdKind),
                            ExpectedPropertyValue = referenceObject.ResourceIdKind,
                        };

                        return result;
                    },
                    PropertyName = "ResourceIdKind",
                });

        private static readonly DeepCloneWithTestScenarios<MessageAuthorIcon> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MessageAuthorIcon>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MessageAuthorIcon>
                {
                    Name = "DeepCloneWithResourceId should deep clone object and replace ResourceId with the provided resourceId",
                    WithPropertyName = "ResourceId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MessageAuthorIcon>();

                        var referenceObject = A.Dummy<MessageAuthorIcon>().ThatIs(_ => !systemUnderTest.ResourceId.IsEqualTo(_.ResourceId));

                        var result = new SystemUnderTestDeepCloneWithValue<MessageAuthorIcon>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ResourceId,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MessageAuthorIcon>
                {
                    Name = "DeepCloneWithResourceIdKind should deep clone object and replace ResourceIdKind with the provided resourceIdKind",
                    WithPropertyName = "ResourceIdKind",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MessageAuthorIcon>();

                        var referenceObject = A.Dummy<MessageAuthorIcon>().ThatIs(_ => !systemUnderTest.ResourceIdKind.IsEqualTo(_.ResourceIdKind));

                        var result = new SystemUnderTestDeepCloneWithValue<MessageAuthorIcon>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ResourceIdKind,
                        };
        ...
        private static readonly MessageAuthorIcon ReferenceObjectForEquatableTestScenarios = A.Dummy<MessageAuthorIcon>();

        private static readonly EquatableTestScenarios<MessageAuthorIcon> EquatableTestScenarios = new EquatableTestScenarios<MessageAuthorIcon>()
            .AddScenario(() =>
                new EquatableTestScenario<MessageAuthorIcon>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MessageAuthorIcon[]
                    {
                        new MessageAuthorIcon(
                                ReferenceObjectForEquatableTestScenarios.ResourceId,
                                ReferenceObjectForEquatableTestScenarios.ResourceIdKind),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new MessageAuthorIcon[]
                    {
                        new MessageAuthorIcon(
                                A.Dummy<MessageAuthorIcon>().Whose(_ => !_.ResourceId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ResourceId)).ResourceId,
                                ReferenceObjectForEquatableTestScenarios.ResourceIdKind),
                        new MessageAuthorIcon(
                                ReferenceObjectForEquatableTestScenarios.ResourceId,
                                A.Dummy<MessageAuthorIcon>().Whose(_ => !_.ResourceIdKind.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ResourceIdKind)).ResourceIdKind),
                    },
        ...
        private static readonly ValidModelTestScenarios<MessageAuthorIcon> ValidModelTestScenarios = new ValidModelTestScenarios<MessageAuthorIcon>()
            .AddScenario(() =>
                new ValidModelTestScenario<MessageAuthorIcon>
                {
                    Name = "a dummy MessageAuthorIcon should be valid",
                    SystemUnderTest = A.Dummy<MessageAuthorIcon>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void MessageAuthorIcon___Should_implement_IModel_of_MessageAuthorIcon___When_reflecting()
            {
                // Arrange
                var type = typeof(MessageAuthorIcon);

                var expectedModelMethods = typeof(IModel<MessageAuthorIcon>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MessageAuthorIcon>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MessageAuthorIcon___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MessageAuthorIcon);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (MessageAuthorIcon)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "ResourceId", "ResourceIdKind" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (MessageAuthorIcon)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(MessageAuthorIcon).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MessageAuthorIcon>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                MessageAuthorIcon systemUnderTest1 = null;
                MessageAuthorIcon systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    MessageAuthorIcon systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MessageAuthorIcon___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MessageAuthorIcon___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MessageAuthorIcon___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MessageAuthorIcon___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MessageAuthorIcon___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
