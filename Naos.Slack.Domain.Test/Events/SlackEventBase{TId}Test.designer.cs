...
namespace Naos.Slack.Domain.Test
{
    ...
    {
        private static readonly SlackEventBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<SlackEventBase<Version>>();

        private static readonly EquatableTestScenarios<SlackEventBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<SlackEventBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<SlackEventBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SlackEventBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new SlackEventBase<Version>[]
                    {
                        ...
                        // (SlackEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<SlackEventBase<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        // (SlackEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithId(A.Dummy<SlackEventBase<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new SlackEventBase<Version>[]
                    {
                        A.Dummy<SlackEventBase<Version>>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void SlackEventBase_of_Version___Should_implement_IModel_of_SlackEventBase_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(SlackEventBase<Version>);

                var expectedModelMethods = typeof(IModel<SlackEventBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SlackEventBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SlackEventBase_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SlackEventBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<SlackEventBase<Version>>();

                // Act
                var actual = (SlackEventBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SlackEventBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                SlackEventBase<Version> systemUnderTest1 = null;
                SlackEventBase<Version> systemUnderTest2 = null;
