    ...
    public partial class SendSlackTextMessageRequest : IModel<SendSlackTextMessageRequest>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Channel, options, propertyPathTracker, nameof(this.Channel));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MessageAuthorIconOverride, options, propertyPathTracker, nameof(this.MessageAuthorIconOverride));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MessageAuthorUsernameOverride, options, propertyPathTracker, nameof(this.MessageAuthorUsernameOverride));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TextFormat, options, propertyPathTracker, nameof(this.TextFormat));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
