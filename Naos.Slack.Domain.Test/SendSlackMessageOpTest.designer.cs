...
namespace Naos.Slack.Domain.Test
{
    ...
    public static partial class SendSlackMessageOpTest
    {
                ...
                new StringRepresentationTestScenario<SendSlackMessageOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<SendSlackMessageOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Slack.Domain.SendSlackMessageOp: SlackMessageRequest = {systemUnderTest.SlackMessageRequest?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SendSlackMessageOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SendSlackMessageOp>().ThatIs(_ => !systemUnderTest.SlackMessageRequest.IsEqualTo(_.SlackMessageRequest));
        ...
        private static readonly EquatableTestScenarios<SendSlackMessageOp> EquatableTestScenarios = new EquatableTestScenarios<SendSlackMessageOp>()
            .AddScenario(() =>
                new EquatableTestScenario<SendSlackMessageOp>
                {
                    ...
                    {
                        new SendSlackMessageOp(
                                A.Dummy<SendSlackMessageOp>().Whose(_ => !_.SlackMessageRequest.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SlackMessageRequest)).SlackMessageRequest),
                    },
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "SlackMessageRequest" };
        ...
        public static class Equality
        {
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<SlackMessageResponse> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<SlackMessageResponse>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<SlackMessageResponse>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<SlackMessageResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<SlackMessageResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<SlackMessageResponse>)_)).ToList();
