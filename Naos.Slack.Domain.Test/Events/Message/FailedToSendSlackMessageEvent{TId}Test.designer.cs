...
namespace Naos.Slack.Domain.Test
{
    ...
    public static partial class FailedToSendSlackMessageEventTIdTest
    {
        ...
        private static readonly ValidModelTestScenarios<FailedToSendSlackMessageEvent<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<FailedToSendSlackMessageEvent<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<FailedToSendSlackMessageEvent<Version>>
                {
                    Name = "a dummy FailedToSendSlackMessageEvent<Version> should be valid",
                    SystemUnderTest = A.Dummy<FailedToSendSlackMessageEvent<Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void FailedToSendSlackMessageEvent_of_Version___Should_implement_IModel_of_FailedToSendSlackMessageEvent_of_Version___When_reflecting()
            {
                // Arrange
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FailedToSendSlackMessageEvent_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(FailedToSendSlackMessageEvent<Version>);
        ...
        public static class EqualityTesting
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailedToSendSlackMessageEvent_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailedToSendSlackMessageEvent_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailedToSendSlackMessageEvent_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailedToSendSlackMessageEvent_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailedToSendSlackMessageEvent_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
