    ...
    public static partial class SendSlackTextMessageRequestTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SendSlackTextMessageRequest> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SendSlackTextMessageRequest>()
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SendSlackTextMessageRequest>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'textFormat' is SlackTextFormat.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SendSlackTextMessageRequest>();
        ...
        private static readonly ValidModelTestScenarios<SendSlackTextMessageRequest> ValidModelTestScenarios = new ValidModelTestScenarios<SendSlackTextMessageRequest>()
            .AddScenario(() =>
                new ValidModelTestScenario<SendSlackTextMessageRequest>
                {
                    Name = "a dummy SendSlackTextMessageRequest should be valid",
                    SystemUnderTest = A.Dummy<SendSlackTextMessageRequest>(),
                });
