    ...
    public partial class SucceededInUploadingFileToSlackEvent<TId> : IModel<SucceededInUploadingFileToSlackEvent<TId>>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.UploadFileToSlackResponse, options, propertyPathTracker, nameof(this.UploadFileToSlackResponse));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
