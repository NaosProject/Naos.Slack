...
namespace Naos.Slack.Domain
{
    ...
    public partial class SendSlackMessageResponse : IModel<SendSlackMessageResponse>
    {
        ...
        /// <returns>New <see cref="SendSlackMessageResponse" /> using the specified <paramref name="timestampId" /> for <see cref="TimestampId" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SendSlackMessageResponse DeepCloneWithTimestampId(string timestampId)
        {
            var result = new SendSlackMessageResponse(
                                 this.SendSlackMessageResult,
                                 timestampId,
        ...
        /// <returns>New <see cref="SendSlackMessageResponse" /> using the specified <paramref name="channelId" /> for <see cref="ChannelId" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SendSlackMessageResponse DeepCloneWithChannelId(string channelId)
        {
            var result = new SendSlackMessageResponse(
                                 this.SendSlackMessageResult,
                                 this.TimestampId?.DeepClone(),
        ...
        /// <returns>New <see cref="SendSlackMessageResponse" /> using the specified <paramref name="slackErrorCode" /> for <see cref="SlackErrorCode" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SendSlackMessageResponse DeepCloneWithSlackErrorCode(string slackErrorCode)
        {
            var result = new SendSlackMessageResponse(
                                 this.SendSlackMessageResult,
                                 this.TimestampId?.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Slack.Domain.SendSlackMessageResponse: SendSlackMessageResult = {this.SendSlackMessageResult.ToString() ?? "<null>"}, TimestampId = {this.TimestampId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ChannelId = {this.ChannelId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ExceptionToString = {this.ExceptionToString?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, SlackErrorCode = {this.SlackErrorCode?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
