...
namespace Naos.Slack.Domain
{
    ...
    [Serializable]
    public partial class SucceededInSendingSlackMessageEvent<TId> : IModel<SucceededInSendingSlackMessageEvent<TId>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SucceededInSendingSlackMessageEvent{TId}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SucceededInSendingSlackMessageEvent<TId> left, SucceededInSendingSlackMessageEvent<TId> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SucceededInSendingSlackMessageEvent{TId}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SucceededInSendingSlackMessageEvent<TId> left, SucceededInSendingSlackMessageEvent<TId> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SucceededInSendingSlackMessageEvent<TId> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SucceededInSendingSlackMessageEvent<TId>);
        ...
        /// <inheritdoc />
        public new SucceededInSendingSlackMessageEvent<TId> DeepClone() => (SucceededInSendingSlackMessageEvent<TId>)this.DeepCloneInternal();
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.SendSlackMessageResponse, options, propertyPathTracker, nameof(this.SendSlackMessageResponse));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
