...
namespace Naos.Slack.Domain
{
    ...
    [Serializable]
    public partial class SendSlackMessageOp : IModel<SendSlackMessageOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SendSlackMessageOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SendSlackMessageOp left, SendSlackMessageOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SendSlackMessageOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SendSlackMessageOp left, SendSlackMessageOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SendSlackMessageOp other)
        {
            ...
            var result = this.SendSlackMessageRequest.IsEqualTo(other.SendSlackMessageRequest);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SendSlackMessageOp);
        ...
        /// <inheritdoc />
        public new SendSlackMessageOp DeepClone() => (SendSlackMessageOp)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="SendSlackMessageOp" /> using the specified <paramref name="sendSlackMessageRequest" /> for <see cref="SendSlackMessageRequest" /> and a deep clone of every other property.</returns>
        ...
        public SendSlackMessageOp DeepCloneWithSendSlackMessageRequest(SendSlackMessageRequestBase sendSlackMessageRequest)
        {
        ...
        {
            var result = Invariant($"Naos.Slack.Domain.SendSlackMessageOp: SendSlackMessageRequest = {this.SendSlackMessageRequest?.ToString() ?? "<null>"}.");
