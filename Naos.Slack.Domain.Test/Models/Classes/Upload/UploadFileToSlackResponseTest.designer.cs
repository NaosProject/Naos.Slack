...
namespace Naos.Slack.Domain.Test
{
    ...
    public static partial class UploadFileToSlackResponseTest
    {
        ...
        private static readonly ValidModelTestScenarios<UploadFileToSlackResponse> ValidModelTestScenarios = new ValidModelTestScenarios<UploadFileToSlackResponse>()
            .AddScenario(() =>
                new ValidModelTestScenario<UploadFileToSlackResponse>
                {
                    Name = "a dummy UploadFileToSlackResponse should be valid",
                    SystemUnderTest = A.Dummy<UploadFileToSlackResponse>(),
                });
