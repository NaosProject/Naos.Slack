...
namespace Naos.Slack.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SlackAuthToken> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SlackAuthToken>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<SlackAuthToken>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SlackAuthToken>();

                        var result = new SystemUnderTestExpectedStringRepresentation<SlackAuthToken>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Slack.Domain.SlackAuthToken: Value = {systemUnderTest.Value?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SlackAuthToken> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SlackAuthToken>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SlackAuthToken>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'value' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new SlackAuthToken(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<SlackAuthToken> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SlackAuthToken>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SlackAuthToken>
                {
                    Name = "Value should return same 'value' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SlackAuthToken>();

                        var result = new SystemUnderTestExpectedPropertyValue<SlackAuthToken>
                        {
                            SystemUnderTest = new SlackAuthToken(
        ...
        private static readonly DeepCloneWithTestScenarios<SlackAuthToken> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SlackAuthToken>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SlackAuthToken>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SlackAuthToken>().ThatIs(_ => !systemUnderTest.Value.IsEqualTo(_.Value));

                        var result = new SystemUnderTestDeepCloneWithValue<SlackAuthToken>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly SlackAuthToken ReferenceObjectForEquatableTestScenarios = A.Dummy<SlackAuthToken>();

        private static readonly EquatableTestScenarios<SlackAuthToken> EquatableTestScenarios = new EquatableTestScenarios<SlackAuthToken>()
            .AddScenario(() =>
                new EquatableTestScenario<SlackAuthToken>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SlackAuthToken[]
                    {
                        new SlackAuthToken(
                                ReferenceObjectForEquatableTestScenarios.Value),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new SlackAuthToken[]
                    {
                        new SlackAuthToken(
                                A.Dummy<SlackAuthToken>().Whose(_ => !_.Value.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Value)).Value),
                    },
        ...
        private static readonly ValidModelTestScenarios<SlackAuthToken> ValidModelTestScenarios = new ValidModelTestScenarios<SlackAuthToken>()
            .AddScenario(() =>
                new ValidModelTestScenario<SlackAuthToken>
                {
                    Name = "a dummy SlackAuthToken should be valid",
                    SystemUnderTest = A.Dummy<SlackAuthToken>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void SlackAuthToken___Should_implement_IModel_of_SlackAuthToken___When_reflecting()
            {
                // Arrange
                var type = typeof(SlackAuthToken);

                var expectedModelMethods = typeof(IModel<SlackAuthToken>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SlackAuthToken>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SlackAuthToken___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SlackAuthToken);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SlackAuthToken)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SlackAuthToken)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SlackAuthToken).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SlackAuthToken>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                SlackAuthToken systemUnderTest1 = null;
                SlackAuthToken systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    SlackAuthToken systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SlackAuthToken___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SlackAuthToken___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SlackAuthToken___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SlackAuthToken___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SlackAuthToken___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
