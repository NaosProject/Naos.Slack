...
namespace Naos.Slack.Domain.Test
{
    ...
    {
        private static readonly SlackMessageResponseEventBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<SlackMessageResponseEventBase<Version>>();

        private static readonly EquatableTestScenarios<SlackMessageResponseEventBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<SlackMessageResponseEventBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<SlackMessageResponseEventBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SlackMessageResponseEventBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new SlackMessageResponseEventBase<Version>[]
                    {
                        ...
                        // (SlackMessageResponseEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<SlackMessageResponseEventBase<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        // (SlackMessageResponseEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithId(A.Dummy<SlackMessageResponseEventBase<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithSlackMessageResponse(A.Dummy<SlackMessageResponseEventBase<Version>>().Whose(_ => !_.SlackMessageResponse.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SlackMessageResponse)).SlackMessageResponse),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new SlackMessageResponseEventBase<Version>[]
                    {
                        A.Dummy<SlackMessageResponseEventBase<Version>>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void SlackMessageResponseEventBase___Should_implement_IModel_of_SlackMessageResponseEventBase___When_reflecting()
            {
                // Arrange
                var type = typeof(SlackMessageResponseEventBase<Version>);

                var expectedModelMethods = typeof(IModel<SlackMessageResponseEventBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SlackMessageResponseEventBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SlackMessageResponseEventBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SlackMessageResponseEventBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<SlackMessageResponseEventBase<Version>>();

                // Act
                var actual = (SlackMessageResponseEventBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SlackMessageResponseEventBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                SlackMessageResponseEventBase<Version> systemUnderTest1 = null;
                SlackMessageResponseEventBase<Version> systemUnderTest2 = null;
